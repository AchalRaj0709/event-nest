...
const users = [
    { name: 'Admin User', email: 'admin@eventnest.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@eventnest.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@eventnest.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@eventnest.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@eventnest.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@eventnest.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@eventnest.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@eventnest.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@eventnest.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@eventnest.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@eventnest.com');
        console.log('User Email:  user@eventnest.com');
